...
def discount_price(price):
    ...
    # 반드시 결과 값을 result 변수에 할당하여 반환
    float(price)
    result = price * 0.8 if price >= 100000 else price * 0.9
       # ==================================
    return result
...
def binary_converter(decimal_number):
    ...
    #     print("=================loopcounter ==========")
    #     print("init : " , temp_number)
    #     print("remainder : " , remainder)
    #     print("temp_result : " , temp_result)
    #     print("output decimal  : " , decimal_number)
    #     print("result   : " , result)
...
def main():
    ...
    list_data = [1,2,3,4,5]
    result = sum_of_list(list_data)
    print("sum_of_list 결과값 : " , result)
    
    list_data_a = [1,2,3,4,5]
    list_data_b = [6,7,8,9,10]
    mergeResult = merge_and_sort(list_data_a, list_data_b)
    print("mergeResult 결과값 : " , mergeResult)

    list_data = [1,2,3,4,5]
    element_value = 5
    deleteResult = delete_a_list_element(list_data, element_value)
    print("deleteResult 결과값 : " , deleteResult)
    
    list_data_a = [1,2,3,4,5]
    list_data_b = [6,7,8,9,10]
    comparisonResult = comparison_list_size(list_data_a, list_data_b)
    print("comparisonResult 결과값 : " , comparisonResult)

    oddResult = odd_even_check(4, 4)
    print("oddResult 결과값 : " , oddResult)

    price = 40000
    discountResult = discount_price(price)
    print("discountResult 결과값 : " , discountResult)

    list_data = [1,2,3,4,5]
    findList = find_smallest_value(list_data)
    print("findList 결과값 : " , findList)

    convertResult = binary_converter(100)
    print("convertResult 결과값 : " , convertResult)

    list_data = ['a','b','b']
    caseResult = number_of_cases(list_data)
    print("caseResult 결과값 : " , caseResult)
     # ==================================
