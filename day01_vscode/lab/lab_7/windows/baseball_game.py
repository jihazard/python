...
def is_between_100_and_999(user_input_number):
    ...
    if is_digit(user_input_number):
        if len(user_input_number) > 100 and len(user_input_number) < 1000:
            result = True
        else:
            result = False        
    else:
...
def main():
    ...
    print(is_yes("Yes1"))
    print(is_no("NO1"))
    print(is_digit("1032.203"))
    print(get_random_number())

    print(is_between_100_and_999("473"))
    # ==================================
